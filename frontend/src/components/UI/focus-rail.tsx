  ...
  return (
    ...
    >
      ...
      {/* {onClose && (
        <button 
            onClick={onClose}
            className="absolute top-4 right-4 z-50 p-2 bg-black/50 hover:bg-black/80 rounded-full text-white/50 hover:text-white transition-colors"
        >
      ...
      {/* Main Stage */}
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8 h-full">
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                key={absIndex}
                className={cn(
                  "absolute aspect-[3/5] w-[280px] md:w-[320px] rounded-2xl border-t border-white/20 bg-neutral-900 shadow-2xl transition-shadow duration-300 overflow-hidden group",
        ...
        {/* Info & Controls */}
        <div className="absolute bottom-8 left-0 right-0 z-20 mx-auto mt-0 flex w-full max-w-4xl items-center justify-center gap-6 px-4 pointer-events-auto">
